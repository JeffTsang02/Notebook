...
import CommonConstants from '@bundle:com.example.component/entry/ets/constants/CommonConstants';
import Rdb from '@bundle:com.example.component/entry/ets/database/Rdb';
...
export default class MemoTable {
    ...
    constructor(callback = () => {
        ...
        this.memoTable = new Rdb(CommonConstants.MEMO_TABLE.tableName, CommonConstants.MEMO_TABLE.sqlCreate, CommonConstants.MEMO_TABLE.columns);
    ...
    query(callback) {
        ...
        this.memoTable.query(predicates, (resultSet) => {
            // 创建局部变量，存储结果的行数
...
function generateBucket(memo) {
    let obj = {};
    obj.updateTime = memo.updateTime;
    obj.content = memo.content;
    return obj;
}
//# sourceMappingURL=MemoTable.js.map